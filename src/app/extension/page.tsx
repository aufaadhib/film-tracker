      ...
      <main id="main-content">
        <section className={styles.hero}>
          ...
          <div className={styles.heroActions}>
            <a className={styles.download} href={`/downloads/${extensionArchive}`} download>Unduh extension v{extensionVersion} (.zip)</a>
        ...
        <aside className={styles.notice}><CheckIcon size={22} /><div><h2>Yang sudah bekerja</h2><p>Deteksi empat platform, progres posisi video, antrean offline, serta login dan sinkronisasi ke dashboard Reelmark.</p></div><span>BETA</span></aside>
