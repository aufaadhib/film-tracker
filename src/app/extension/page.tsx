      ...
      <main id="main-content">
        <section className={styles.hero}>
          ...
          <div className={styles.heroActions}>
            <a className={styles.download} href="/downloads/reelmark-extension-0.7.13.zip" download>Unduh extension v0.7.13 (.zip)</a>
        ...
        <section className={styles.steps} aria-labelledby="steps-title">
          ...
          <ol>
            <li><span>01</span><div><h3>Unduh dan ekstrak ZIP</h3><p>Tekan tombol unduh di atas, lalu ekstrak <code>reelmark-extension-0.7.13.zip</code>.</p></div></li>
        ...
        <aside className={styles.notice}><CheckIcon size={22} /><div><h2>Yang sudah bekerja</h2><p>Deteksi empat platform, progres posisi video, antrean offline, serta login dan sinkronisasi ke dashboard lokal.</p></div><span>BETA</span></aside>
