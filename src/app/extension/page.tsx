      ...
      <main id="main-content">
        <section className={styles.hero}>
          ...
          <div className={styles.heroActions}>
            <a className={styles.download} href="/downloads/reelmark-extension-0.5.0.zip" download>Unduh extension v0.5.0 (.zip)</a>
        ...
        <section className={styles.steps} aria-labelledby="steps-title">
          ...
          <ol>
            <li><span>01</span><div><h3>Unduh dan ekstrak ZIP</h3><p>Tekan tombol unduh di atas, lalu ekstrak <code>reelmark-extension-0.5.0.zip</code>.</p></div></li>
